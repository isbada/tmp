...
int remove_book(struct Book book);//adds a book to the ones available to the library

//returns 0 if the book could be borrowed, or an error code otherwise
int borrow_book(struct Book book);

//removes a book from the library
//returns 0 if the book could be successfully returned, or an error code otherwise.
